...
"$HOME/.preemdeck/preemdeck-runtime" "$HOME/.preemdeck/source/ripperdoc/wetware/ghost/scripts/ghost.ts" decode

# Edit the .md files, then re-encode
"$HOME/.preemdeck/preemdeck-runtime" "$HOME/.preemdeck/source/ripperdoc/wetware/ghost/scripts/ghost.ts" encode
```
...
"$HOME/.preemdeck/preemdeck-runtime" "$HOME/.preemdeck/source/ripperdoc/wetware/ghost/scripts/ghost.ts" flatline
```
