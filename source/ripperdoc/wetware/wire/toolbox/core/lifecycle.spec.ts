/**
 * lifecycle.spec.ts — the deterministic operational layer.
 *
 ...
 * port bind-probe) is injected. The integration start/stop cycle that spawns a
 * real server is covered elsewhere.
 */
