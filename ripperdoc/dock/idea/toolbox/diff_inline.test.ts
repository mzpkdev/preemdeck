/**
 * diff_inline.test.ts — hermetic port of test_diff_inline.py. The worker delegate
...
import { _internals, diffInline, main } from "./diff_inline.ts";
...
function spy(result: string | null = RECONCILED) {
