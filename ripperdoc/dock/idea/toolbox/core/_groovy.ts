/**
 * _groovy.ts — shared ideScript bridge: escape a Groovy literal + run a one-shot
...
import { IdeaError, NotImplementedError } from "./_errors.ts";
import { launch as defaultLaunch, type LaunchOptions } from "./_launch.ts";
import { reapLater as defaultReapLater } from "./_reap.ts";
 ...
 */
export async function runGroovy(groovy: string, note: string, deps: RunGroovyDeps = {}): Promise<void> {
