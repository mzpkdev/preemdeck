/**
 * _preview.ts — force the running JetBrains IDE to a rendered preview
...
import { escapeGroovy, type RunGroovyDeps, runGroovy } from "./_groovy.ts";
 ...
 */
function groovySetLayout(path: string): string {
 ...
 */
function groovyWebPreview(path: string): string {
  return `import com.intellij.openapi.application.ApplicationManager
import com.intellij.openapi.fileEditor.FileEditorManager
import com.intellij.openapi.project.ProjectManager
 ...
 */
function webpreviewOpenBodyRaw(url: string, title: string, projectVar: string): string {
...
export interface WebpreviewOpenBodyOptions {
  /**
 ...
 * `escapeGroovy`).
 */
export function webpreviewOpenBody(
  urlLiteral: string,
  titleLiteral: string,
 ...
 */
function groovyUrlPreview(body: string): string {
  return `import com.intellij.openapi.application.ApplicationManager
import com.intellij.openapi.project.ProjectManager
 ...
 */
function groovyFor(path: string): string {
 ...
 */
export async function setPreview(path: string, deps: RunGroovyDeps = {}): Promise<void> {
 ...
 */
export async function previewUrl(url: string, title?: string, deps: RunGroovyDeps = {}): Promise<void> {
