/**
 * _launch.ts — launch the running JetBrains IDE (cross-platform), optionally
 ...
 */
export async function launch(args: string[], options: LaunchOptions = {}): Promise<Bun.Subprocess> {
