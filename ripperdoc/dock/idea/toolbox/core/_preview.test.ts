/**
 * _preview.test.ts — hermetic: no real IDE, no ideScript, no polling. Port of
...
import type { RunGroovyDeps } from "./_groovy.ts";
import { previewUrl, setPreview, webpreviewOpenBody } from "./_preview.ts";
...
function captureDeps(raises?: unknown): {
  deps: RunGroovyDeps;
  scripts: string[];
