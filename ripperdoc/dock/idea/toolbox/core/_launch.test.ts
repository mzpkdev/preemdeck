/**
 * _launch.test.ts — hermetic, no real subprocess or IDE. Port of test_launch.py.
 *
...
import { launch, type Spawn } from "./_launch.ts";
...
function fakeSpawn(): { spawn: Spawn; last: () => FakeChild | undefined } {
