/**
 * _reap.test.ts — hermetic, no real wall-clock delay. Port of test_reap.py.
 *
...
import { REAP_DELAY_MS, reapLater } from "./_reap.ts";
 ...
 * unlink it kicks off.
 */
function armed(paths: Iterable<string>, delayMs?: number): { delay: number; fire: () => Promise<void> } {
