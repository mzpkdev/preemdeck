/**
 * idea-mac.test.ts — hermetic, no real `ps` or IDE. Driven by a
 * live-captured WebStorm ancestry fixture.
 *
 ...
 * spawning `ps` (the original suite monkeypatched `idea_mac.subprocess.run` +
