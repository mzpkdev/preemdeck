"""JetBrains IDE detection for the idea toolbox (Windows) — not implemented yet.

Stub module: mirrors the macOS surface (in_idea, resolve_exec_path,
...
def in_idea() -> bool:
    ...
    raise NotImplementedError("in_idea is not implemented for Windows yet")
