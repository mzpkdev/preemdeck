/**
 * _cli.ts — argparse-faithful usage/error emission for the toolbox CLIs.
 *
...
export function argparseError(usage: string, prog: string, message: string): never {
 ...
 */
export function argparseMessage(err: unknown): string {
