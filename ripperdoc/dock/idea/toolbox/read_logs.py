...
from core import IdeaError, in_idea, resolve_log_dir
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        # resolve_log_dir()'s deeper resolve_exec_path() ancestry walk. Reuse the
    ...
    except (IdeaError, OSError) as exc:
