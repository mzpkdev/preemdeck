...
/**
 * Hook entrypoint: best-effort, SILENT, ALWAYS exits 0. No-op outside a JetBrains
 * IDE; otherwise derives a per-tab `<project> · <branch>` title + a one-line gist
 * of the just-finished reply and pops the turn-end balloon.
 */
