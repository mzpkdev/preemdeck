/**
 * turn-notify.test.ts — hermetic port of test_turn_notify.py. The pure formatters
...
import { _internals, cleanGist, GIST_MAX, main, payloadGist, title } from "./turn-notify.ts";
...
const capture = (): Array<{ body: string; title: string }> => {
