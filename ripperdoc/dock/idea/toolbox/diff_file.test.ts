/**
 * diff_file.test.ts — hermetic port of test_diff_file.py. launch + inIdea +
...
import { _internals, diffFile, main } from "./diff_file.ts";
...
function stubLaunch(writeTo?: string, text = RECONCILED) {
...
function makeInputs(): { target: string; suggestion: string } {
