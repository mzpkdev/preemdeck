#!/usr/bin/env bun
/**
 * diff_file.ts — diff two files in the running JetBrains IDE. Behavior-identical
...
import { resolveStrict } from "./_tmp.ts";
 ...
 */
export async function diffFile(target: string, suggestion: string, wait = false): Promise<string | null> {
