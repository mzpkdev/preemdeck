/**
 * merge_file.test.ts — hermetic port of test_merge_file.py. launch + inIdea +
...
import { _internals, main, mergeFile } from "./merge_file.ts";
...
function stubLaunch(text = MERGED) {
...
function makeInputs(): { target: string; suggestion: string; base: string } {
