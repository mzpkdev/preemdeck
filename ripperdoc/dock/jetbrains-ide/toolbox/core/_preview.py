...
def _run_groovy(groovy: str, *, note: str) -> None:
    ...
    A missing live IDE (JetBrainsError), an unimplemented platform
    ...
    try:
        ...
        except (JetBrainsError, NotImplementedError, OSError) as exc:
...
def set_preview(path: str) -> None:
    ...
    NEVER raises: a missing live IDE (JetBrainsError), an unimplemented platform
