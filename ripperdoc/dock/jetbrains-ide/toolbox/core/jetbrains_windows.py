...
def in_jetbrains() -> bool:
    """True when our terminal was launched by a JetBrains IDE - unimplemented on Windows."""
    raise NotImplementedError("in_jetbrains is not implemented for Windows yet")


def resolve_exec_path() -> str:
    """Absolute path to the JetBrains IDE binary we're running inside - unimplemented on Windows."""
    raise NotImplementedError("resolve_exec_path is not implemented for Windows yet")


def resolve_log_dir() -> Path:
    """Log dir of the IDE we're running inside - unimplemented on Windows."""
