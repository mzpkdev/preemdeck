...
from core import JetBrainsError, preview_url, resolve_exec_path
...
def open_url(url: str, title: str | None = None) -> None:
    ...
    for a live IDE — it raises JetBrainsError (no IDE in the ancestry) or
...
def main(argv: list[str]) -> int:
    ...
    except (JetBrainsError, NotImplementedError) as exc:
