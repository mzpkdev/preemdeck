/**
 * inject_mode.test.ts — port of test_inject_mode.py. Tmp-fixture FS for the
...
import { extractEvent, findConfig, loadModeText, renderBodies, selectVariants } from "./inject_mode.ts";
...
async function writeCfg(text: string): Promise<string> {
