/**
 * set_mode.test.ts — port of test_set_mode.py. Tmp-fixture FS; the exit-code path
...
import { availableModes, configSlots, ModesError, main, setDirective, slotFor } from "./set_mode.ts";
