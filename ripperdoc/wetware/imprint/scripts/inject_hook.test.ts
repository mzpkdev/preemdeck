/**
 * inject_hook.test.ts — port of test_inject_hook.py. Tmp-fixture FS for templates
...
import { extractEventArg, renderTemplate, resolveTemplateArg } from "./inject_hook.ts";
...
async function runHookCli(argv: string[], stdinText: string): Promise<{ out: string }> {
