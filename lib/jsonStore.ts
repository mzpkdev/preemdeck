/**
 * lib/jsonStore.ts — atomic JSON read/write for preemdeck.json mode-state.
 *
 * Byte-compatible with the Python writer (set_mode.py `set_directive`):
 ...
 * partial file. Matches set_mode.py byte-for-byte.
 */
